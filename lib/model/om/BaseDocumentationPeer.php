...
abstract class BaseDocumentationPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Title', 'Description', 'YoutubeUrl', 'CreatedAt', 'UpdatedAt', 'CreatedBy', 'UpdatedBy', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'title', 'description', 'youtubeUrl', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', ),
        BasePeer::TYPE_COLNAME => array (DocumentationPeer::ID, DocumentationPeer::NAME, DocumentationPeer::TITLE, DocumentationPeer::DESCRIPTION, DocumentationPeer::YOUTUBE_URL, DocumentationPeer::CREATED_AT, DocumentationPeer::UPDATED_AT, DocumentationPeer::CREATED_BY, DocumentationPeer::UPDATED_BY, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'TITLE', 'DESCRIPTION', 'YOUTUBE_URL', 'CREATED_AT', 'UPDATED_AT', 'CREATED_BY', 'UPDATED_BY', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'title', 'description', 'youtube_url', 'created_at', 'updated_at', 'created_by', 'updated_by', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Title' => 2, 'Description' => 3, 'YoutubeUrl' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, 'CreatedBy' => 7, 'UpdatedBy' => 8, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'title' => 2, 'description' => 3, 'youtubeUrl' => 4, 'createdAt' => 5, 'updatedAt' => 6, 'createdBy' => 7, 'updatedBy' => 8, ),
        BasePeer::TYPE_COLNAME => array (DocumentationPeer::ID => 0, DocumentationPeer::NAME => 1, DocumentationPeer::TITLE => 2, DocumentationPeer::DESCRIPTION => 3, DocumentationPeer::YOUTUBE_URL => 4, DocumentationPeer::CREATED_AT => 5, DocumentationPeer::UPDATED_AT => 6, DocumentationPeer::CREATED_BY => 7, DocumentationPeer::UPDATED_BY => 8, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'TITLE' => 2, 'DESCRIPTION' => 3, 'YOUTUBE_URL' => 4, 'CREATED_AT' => 5, 'UPDATED_AT' => 6, 'CREATED_BY' => 7, 'UPDATED_BY' => 8, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'title' => 2, 'description' => 3, 'youtube_url' => 4, 'created_at' => 5, 'updated_at' => 6, 'created_by' => 7, 'updated_by' => 8, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
