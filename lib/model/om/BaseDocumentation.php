...
/**
 * Base class that represents a row from the 'documentations' table.
 *
 *
 *
 * @package    propel.generator.model.om
 */
abstract class BaseDocumentation extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DocumentationPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        DocumentationPeer
     */
    ...
    /**
     * @var        PropelObjectCollection|DocumentationPart[] Collection to store aggregation of DocumentationPart objects.
     */
    protected $collDocumentationParts;
    protected $collDocumentationPartsPartial;
     ...
     */
    protected $documentationPartsScheduledForDeletion = null;
    ...
    /**
     * Initializes internal state of BaseDocumentation object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = DocumentationPeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = DocumentationPeer::NAME;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = DocumentationPeer::TITLE;
        }
    ...
    public function setDescription($v)
    {
        ...
        if (!is_resource($v) && $v !== null) {
            ...
            fwrite($this->description, $v);
            rewind($this->description);
        } else { // it's already a stream
            $this->description = $v;
        }
        $this->modifiedColumns[] = DocumentationPeer::DESCRIPTION;
    ...
    public function setYoutubeUrl($v)
    {
        ...
        if ($this->youtube_url !== $v) {
            $this->youtube_url = $v;
            $this->modifiedColumns[] = DocumentationPeer::YOUTUBE_URL;
        }
    ...
    public function setKey($v)
    {
        ...
        if ($this->key !== $v) {
            $this->key = $v;
            $this->modifiedColumns[] = DocumentationPeer::KEY;
        }
    ...
    public function setIsPublished($v)
    {
        ...
        if ($this->is_published !== $v) {
            $this->is_published = $v;
            $this->modifiedColumns[] = DocumentationPeer::IS_PUBLISHED;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DocumentationPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DocumentationPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = DocumentationPeer::CREATED_BY;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DocumentationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DocumentationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // denyable behavior
                if(!(DocumentationPeer::isIgnoringRights() || $this->mayOperate("insert"))) {
                    throw new PropelException(new NotPermittedException("insert.by_role", array("role_key" => "documentations")));
                }
                ...
                // denyable behavior
                if(!(DocumentationPeer::isIgnoringRights() || $this->mayOperate("update"))) {
                    throw new PropelException(new NotPermittedException("update.by_role", array("role_key" => "documentations")));
                }

                // extended_timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(DocumentationPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if ($this->isModified() && !$this->isColumnModified(DocumentationPeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                DocumentationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->documentationPartsScheduledForDeletion !== null) {
                if (!$this->documentationPartsScheduledForDeletion->isEmpty()) {
                    DocumentationPartQuery::create()
                        ->filterByPrimaryKeys($this->documentationPartsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `documentations` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = DocumentationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = DocumentationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collDocumentationParts) {
                $result['DocumentationParts'] = $this->collDocumentationParts->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DocumentationPeer::UPDATED_BY)) $criteria->add(DocumentationPeer::UPDATED_BY, $this->updated_by);
     ...
     * objects.
     *
     * @param object $copyObj An object of Documentation (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getDocumentationParts() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addDocumentationPart($relObj->copy($deepCopy));
                }
            }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Documentation Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DocumentationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DocumentationPeer();
        }
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addDocumentationRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByCreatedBy->addDocumentationsRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addDocumentationRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addDocumentationsRelatedByUpdatedBy($this);
             */
        }
    ...
    {
        if ('DocumentationPart' == $relationName) {
            $this->initDocumentationParts();
        }
    }

    /**
     * Clears out the collDocumentationParts collection
     *
    ...
    /**
     * reset is the collDocumentationParts collection loaded partially
     *
     * @return void
     */
    public function resetPartialDocumentationParts($v = true)
    {
        $this->collDocumentationPartsPartial = $v;
    }

    /**
     * Initializes the collDocumentationParts collection.
     *
     * By default this just sets the collDocumentationParts collection to an empty array (like clearcollDocumentationParts());
     ...
     * @return void
     */
    public function initDocumentationParts($overrideExisting = true)
    {
        if (null !== $this->collDocumentationParts && !$overrideExisting) {
            return;
        }
        $this->collDocumentationParts = new PropelObjectCollection();
        $this->collDocumentationParts->setModel('DocumentationPart');
    }

    /**
     * Gets an array of DocumentationPart objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this Documentation is new, it will return
     ...
     * @throws PropelException
     */
    public function getDocumentationParts($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collDocumentationPartsPartial && !$this->isNew();
        if (null === $this->collDocumentationParts || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collDocumentationParts) {
                // return empty collection
                $this->initDocumentationParts();
            } else {
                $collDocumentationParts = DocumentationPartQuery::create(null, $criteria)
                ...
                $this->collDocumentationParts = $collDocumentationParts;
                $this->collDocumentationPartsPartial = false;
            }
        }

        return $this->collDocumentationParts;
    }

    /**
     * Sets a collection of DocumentationPart objects related by a one-to-many relationship
    ...
    public function setDocumentationParts(PropelCollection $documentationParts, PropelPDO $con = null)
    {
        ...
        $this->collDocumentationParts = null;
        foreach ($documentationParts as $documentationPart) {
            $this->addDocumentationPart($documentationPart);
        }
    ...
    /**
     * Returns the number of related DocumentationPart objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related DocumentationPart objects.
     * @throws PropelException
     */
    public function countDocumentationParts(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collDocumentationPartsPartial && !$this->isNew();
        if (null === $this->collDocumentationParts || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collDocumentationParts) {
    ...
    /**
     * Method called to associate a DocumentationPart object to this object
     * through the DocumentationPart foreign key attribute.
     *
     * @param    DocumentationPart $l DocumentationPart
     * @return Documentation The current object (for fluent API support)
     */
    public function addDocumentationPart(DocumentationPart $l)
    {
        if ($this->collDocumentationParts === null) {
            $this->initDocumentationParts();
            $this->collDocumentationPartsPartial = true;
    ...
    /**
     * @param	DocumentationPart $documentationPart The documentationPart object to add.
     */
    protected function doAddDocumentationPart($documentationPart)
    {
        $this->collDocumentationParts[]= $documentationPart;
        $documentationPart->setDocumentation($this);
    }
    ...
    {
        if ($this->getDocumentationParts()->contains($documentationPart)) {
            $this->collDocumentationParts->remove($this->collDocumentationParts->search($documentationPart));
            if (null === $this->documentationPartsScheduledForDeletion) {
     ...
     * @return PropelObjectCollection|DocumentationPart[] List of DocumentationPart objects
     */
    public function getDocumentationPartsJoinUserRelatedByCreatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = DocumentationPartQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(DocumentationPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        $bIsAllowed = false;
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && DocumentationPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(DocumentationPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
        FilterModule::getFilters()->handleDocumentationOperationCheck($sOperation, $this, $oUser, array(&$bIsAllowed));
        return $bIsAllowed;
    }
