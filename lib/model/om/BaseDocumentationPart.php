...
/**
 * Base class that represents a row from the 'documentation_parts' table.
 *
 *
 *
 * @package    propel.generator.model.om
 */
abstract class BaseDocumentationPart extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DocumentationPartPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        DocumentationPartPeer
     */
    ...
    /**
     * The value for the is_overview field.
    ...
    /**
     * Initializes internal state of BaseDocumentationPart object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [documentation_id] column value.
     *
     * @return int
     */
    public function getDocumentationId()
    {
        return $this->documentation_id;
    }
    ...
    /**
     * Get the [is_overview] column value.
     *
     * @return boolean
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = DocumentationPartPeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = DocumentationPartPeer::NAME;
        }
    ...
    public function setBody($v)
    {
        ...
        $this->modifiedColumns[] = DocumentationPartPeer::BODY;
     ...
     * @return DocumentationPart The current object (for fluent API support)
     */
    public function setDocumentationId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->documentation_id !== $v) {
            $this->documentation_id = $v;
            $this->modifiedColumns[] = DocumentationPartPeer::DOCUMENTATION_ID;
        }

        if ($this->aDocumentation !== null && $this->aDocumentation->getId() !== $v) {
    ...
    public function setImageId($v)
    {
        ...
        if ($this->image_id !== $v) {
            $this->image_id = $v;
            $this->modifiedColumns[] = DocumentationPartPeer::IMAGE_ID;
        }
    ...
    public function setSort($v)
    {
        ...
        if ($this->sort !== $v) {
            $this->sort = $v;
            $this->modifiedColumns[] = DocumentationPartPeer::SORT;
        }
    ...
    /**
     * Sets the value of the [is_overview] column.
     ...
     * @return DocumentationPart The current object (for fluent API support)
     */
    public function setIsOverview($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->is_overview !== $v) {
            $this->is_overview = $v;
            $this->modifiedColumns[] = DocumentationPartPeer::IS_OVERVIEW;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DocumentationPartPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DocumentationPartPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = DocumentationPartPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = DocumentationPartPeer::UPDATED_BY;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DocumentationPartPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DocumentationPartQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // denyable behavior
                if(!(DocumentationPartPeer::isIgnoringRights() || $this->mayOperate("insert"))) {
                ...
                if (!$this->isColumnModified(DocumentationPartPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if (!$this->isColumnModified(DocumentationPartPeer::CREATED_BY)) {
                        $this->setCreatedBy(Session::getSession()->getUser()->getId());
                    }
                    if (!$this->isColumnModified(DocumentationPartPeer::UPDATED_BY)) {
                ...
                // denyable behavior
                if(!(DocumentationPartPeer::isIgnoringRights() || $this->mayOperate("update"))) {
                    throw new PropelException(new NotPermittedException("update.by_role", array("role_key" => "documentations")));
                }

                // extended_timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(DocumentationPartPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if ($this->isModified() && !$this->isColumnModified(DocumentationPartPeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                DocumentationPartPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DocumentationPartPeer::ID)) {
        ...
        if ($this->isColumnModified(DocumentationPartPeer::IMAGE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`IMAGE_ID`';
        }
        if ($this->isColumnModified(DocumentationPartPeer::SORT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `documentation_parts` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = DocumentationPartPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = DocumentationPartPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['DocumentationPart'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DocumentationPart'][$this->getPrimaryKey()] = true;
        $keys = DocumentationPartPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DocumentationPartPeer::UPDATED_BY)) $criteria->add(DocumentationPartPeer::UPDATED_BY, $this->updated_by);
    ...
    {
        $criteria = new Criteria(DocumentationPartPeer::DATABASE_NAME);
        $criteria->add(DocumentationPartPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of DocumentationPart (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return DocumentationPart Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DocumentationPartPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DocumentationPartPeer();
        }
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addDocumentationPartRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByCreatedBy->addDocumentationPartsRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addDocumentationPartRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addDocumentationPartsRelatedByUpdatedBy($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(DocumentationPartPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        $bIsAllowed = false;
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && DocumentationPartPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(DocumentationPartPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
        FilterModule::getFilters()->handleDocumentationPartOperationCheck($sOperation, $this, $oUser, array(&$bIsAllowed));
        return $bIsAllowed;
    }
